...
var lineReader = require('readline').createInterface({
   input : fs.createReadStream('js/csv/FoodFacts.csv') 
});
var i=0;
var lineRecords=[];
var Header = 0;
...
{ 
     for(var j=0;j<countryArray.length;j++)  //put data into object
  {
    ...
    obj["salt"] = saltArray[j];
    obj["sugar"] = sugarArray[j];
    jsonArray.push(obj);
  }
  fs.writeFile('json/Countries1.json', JSON.stringify(jsonArray) , 'utf-8');
